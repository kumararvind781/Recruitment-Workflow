...
<body>
<header class="topbar">
  <div class="brand-wrap"><div class="brand-mark">UNIRE</div><div><h1>UNIRE Recruitment Workflow</h1><p class="muted">Travel back-office hiring panel</p></div></div>
  <nav class="actions">
    <?php if ($user): ?>
      ...
      <?php endif; ?>
      <?php if (($user['role'] ?? '') !== 'manager'): ?><a class="btn btn-outline" href="recruiter-candidates.php">Candidates</a><?php endif; ?>
