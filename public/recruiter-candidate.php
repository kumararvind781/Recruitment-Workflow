...
<div class="container">
    ...
    <div class="accordion-wrap">
        <details class="acc-item" open name="candidate-detail">
            ...
            <div class="acc-body">
                <div class="info-grid">
                    <div class="info-box"><label>Full Name</label><div><?= h($candidate['full_name'] ?? '') ?></div></div>
                    <div class="info-box"><label>Email</label><div><?= h($candidate['email'] ?? '') ?></div></div>
                    <div class="info-box"><label>Phone</label><div><?= h($candidate['phone'] ?? '') ?></div></div>

                    <div class="info-box"><label>Alternate Phone</label><div><?= h($candidate['alternate_phone'] ?? '') ?></div></div>
                    <div class="info-box"><label>Father / Husband Name</label><div><?= h($candidate['father_husband_name'] ?? '') ?></div></div>
                    <div class="info-box"><label>Emergency No</label><div><?= h($candidate['emergency_no'] ?? '') ?></div></div>

                    <div class="info-box"><label>Date of Birth</label><div><?= h($candidate['dob'] ?? '') ?></div></div>
                    <div class="info-box"><label>Age</label><div><?= h($candidate['age'] ?? '') ?></div></div>
                    <div class="info-box"><label>Gender</label><div><?= h($candidate['gender'] ?? '') ?></div></div>

                    <div class="info-box"><label>Marital Status</label><div><?= h($candidate['marital_status'] ?? '') ?></div></div>
                    <div class="info-box"><label>Highest Qualification</label><div><?= h($candidate['highest_qualification'] ?? '') ?></div></div>
                    <div class="info-box"><label>Total Experience</label><div><?= h($candidate['total_experience'] ?? '') ?></div></div>

                    <div class="info-box"><label>Current Company</label><div><?= h($candidate['current_company'] ?? '') ?></div></div>
                    <div class="info-box"><label>Current Salary</label><div><?= h($candidate['current_salary'] ?? '') ?></div></div>
                    <div class="info-box"><label>Expected Salary</label><div><?= h($candidate['expected_salary'] ?? '') ?></div></div>

                    <div class="info-box"><label>Position Applied</label><div><?= h($candidate['position_applied'] ?? '') ?></div></div>
                    <div class="info-box"><label>Department</label><div><?= h($candidate['department'] ?? '') ?></div></div>
                    <div class="info-box"><label>Notice Period</label><div><?= h($candidate['notice_period'] ?? '') ?></div></div>

                    <div class="info-box"><label>Notice Specify</label><div><?= h($candidate['notice_period_specify'] ?? '') ?></div></div>
                    <div class="info-box"><label>Source Type</label><div><?= h($candidate['source_type'] ?? '') ?></div></div>
                    <div class="info-box"><label>Source Reference Name</label><div><?= h($candidate['source_reference_name'] ?? '') ?></div></div>

                    <div class="info-box wide"><label>Current Address</label><div><?= nl2br(h($candidate['address'] ?? '')) ?></div></div>
                    <div class="info-box wide"><label>Permanent Address</label><div><?= nl2br(h($candidate['permanent_address'] ?? '')) ?></div></div>

                    <div class="info-box"><label>City</label><div><?= h($candidate['city'] ?? '') ?></div></div>
                    <div class="info-box"><label>State</label><div><?= h($candidate['state'] ?? '') ?></div></div>
                    <div class="info-box"><label>Pincode</label><div><?= h($candidate['pincode'] ?? '') ?></div></div>

                    <div class="info-box wide"><label>Career Goals</label><div><?= nl2br(h($candidate['career_goals'] ?? '')) ?></div></div>
                    <div class="info-box wide"><label>Interest in Field</label><div><?= nl2br(h($candidate['interest_in_field'] ?? '')) ?></div></div>
                    <div class="info-box wide"><label>Scheduled Exam</label><div><?= nl2br(h($candidate['scheduled_exam'] ?? '')) ?></div></div>

                    <div class="info-box wide"><label>Strengths</label><div><?= nl2br(h($candidate['strengths'] ?? '')) ?></div></div>
                    <div class="info-box wide"><label>Weakness</label><div><?= nl2br(h($candidate['weakness'] ?? '')) ?></div></div>

                    <div class="info-box"><label>EPF Registered</label><div><?= h($candidate['epf_registered'] ?? '') ?></div></div>
                    <div class="info-box"><label>UAN No</label><div><?= h($candidate['uan_no'] ?? '') ?></div></div>
                    <div class="info-box"><label>ESIC Registered</label><div><?= h($candidate['esic_registered'] ?? '') ?></div></div>

                    <div class="info-box"><label>IP No</label><div><?= h($candidate['ip_no'] ?? '') ?></div></div>
                    <div class="info-box"><label>Aadhaar No</label><div><?= h($candidate['aadhaar_no'] ?? '') ?></div></div>
                    <div class="info-box"><label>PAN No</label><div><?= h($candidate['pan_no'] ?? '') ?></div></div>

                    <div class="info-box"><label>Bank Account No</label><div><?= h($candidate['bank_account_no'] ?? '') ?></div></div>
                    <div class="info-box"><label>IFSC Code</label><div><?= h($candidate['ifsc_code'] ?? '') ?></div></div>
                    <div class="info-box"><label>Weekly Working Days</label><div><?= h($candidate['weekly_working_days'] ?? '') ?></div></div>

                    <div class="info-box"><label>Smoking</label><div><?= h($candidate['smoking'] ?? '') ?></div></div>
                    <div class="info-box"><label>Self Vehicle</label><div><?= h($candidate['self_vehicle'] ?? '') ?></div></div>
                    <div class="info-box"><label>Driving Licence</label><div><?= h($candidate['driving_licence'] ?? '') ?></div></div>

                    <div class="info-box wide"><label>Medical Issue</label><div><?= nl2br(h($candidate['medical_issue'] ?? '')) ?></div></div>
                    <div class="info-box wide"><label>Hobbies</label><div><?= nl2br(h($candidate['hobbies'] ?? '')) ?></div></div>
                    ...
                    <div class="info-box"><label>Applied At</label><div><?= h($candidate['applied_at'] ?? '') ?></div></div>
                </div>
            </div>
        </details>
